    ...
    return (
        <div>
            <div className='top-banner flex justify-center items-center'>
                <div className='text-white flex flex-col justify-center items-center w-2/4'>
                    <h2 className='text-4xl font-bold leading-10 mb-3'>A solid network of warehouses, trucks and partners</h2>
