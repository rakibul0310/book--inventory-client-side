    ...
    return (
        <div className='flex flex-col justify-center items-center mt-10 mb-14'>
            ...
            <form onSubmit={handleContact} className='flex flex-col w-3/4 md:w-1/4'>
                ...
                <input className='h-10 pl-3 outline-[#1566AA] border-[1px] border-gray-200' type="text" name="name" id="name" placeholder='Enter your full name' required />
                ...
                <input className='h-10 pl-3 outline-[#1566AA] border-[1px] border-gray-200' type="text" name="subject" id="subject" placeholder='Subject' required />
                <label className='text-lg mt-3 text-left' htmlFor="details">Details</label>
                <textarea className='outline-[#1566AA] border-[1px] border-[#EBEBEB]' name="details" id="details" cols="30" rows="10" placeholder='say something' required></textarea>
                <input className='my-5 px-6 py-1 bg-[#1566AA] text-white text-lg font-semibold cursor-pointer' type="submit" value="Send" />
            </form>
            <ToastContainer />
        </div>
    );
