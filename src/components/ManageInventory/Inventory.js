...
const Inventory = ({ item }) => {
    const { image, name, _id, price, quantity, supplier } = item;
    return (
        <tr>
            ...
            <td className='border border-gray-300'>
                <div className='flex flex-col justify-center items-center p-2'>
                    ...
                    <button className='btn px-4 md:px-6 py-1 text-sm md:text-lg font-normal bg-red-500/70 hover:bg-red-500 duration-500 mt-5'><FontAwesomeIcon icon={faTrash} /> Delete</button>
                </div>
            </td>
        </tr>
    );
