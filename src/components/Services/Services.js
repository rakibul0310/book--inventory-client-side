        ...
        <div className='flex flex-col items-center px-7 mb-20 cursor-pointer'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
                <div className='flex flex-col justify-center border-[1px] border-gray-200 rounded-md hover:scale-105 duration-700 mb-10 md:mb-0'>
                    ...
                    <p className='text-sm font-thin mx-3 mb-3'>We believe that transportation can be done quickly, with safety and at low cost and we emphasize on it. With properly trained staff, modern equipment, facilities infrastructure and love of what we do, we ensure the quality of our services.</p>
                </div>
                <div className='flex flex-col justify-center border-[1px] border-gray-200 rounded-md hover:scale-105 duration-700 mb-10 md:mb-0'>
                    <img className='w-full' src={warhouse} alt="" />
                    <h3 className='text-2xl font-semibold'>Warhouse</h3>
                    <p className='text-sm font-thin'>The services provided are:</p>
                    <ul className='list-inside list-disc '>
                        <li className='text-sm font-extralight'>Warehousing services</li>
                        <li className='text-sm font-extralight'>Palletizing goods</li>
                    </ul>
                </div>
            </div>
        </div>
